...
4.  What level of complexity of the final product are you aiming for?
    ...
    -   We have not discussed this yet as a team

5.  What figures / tables do you anticipate producing?

    -   We have not discussed this yet, but some ideas are:

    -   A line plot of weather and COVID cases on the same axis, maybe faceted or color-coded by different regions

    -   A line plot of how comfortable outside weather is, vs COVID cases, with an R value
